					...
					<ul class="app_list">
						...
						<li class="clear">
                            ...
                            <div class="app_content email_area">
                            	...
                            	<!-- tno 넘겨줘야 하는데 화면에서는 안보이지만 데이터는 보내게 끔 하기 위해서 hidden 사용 -->
						...
						<li class="clear">
							...
							<div class="app_content">
								<input type="text" name="title" class="w100p" id="name_lbl" value="${vo.title}" placeholder="제목을 입력하세요" required="required"/>
							</div>
						</li>
